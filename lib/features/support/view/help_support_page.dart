                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          // AnimatedSize for smooth height animation
                          AnimatedSize(
  ...
  Widget _guideCard(_Guide guide) {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        padding: const EdgeInsets.all(14),
        decoration: BoxDecoration(
          color: guide.color.withValues(alpha: guide.expanded ? 0.14 : 0.08),
          borderRadius: BorderRadius.circular(14),
          boxShadow: guide.expanded
              ? [
                  BoxShadow(
